...
class PDT_get_coreference:    
    def __init__( self, pdt_t_input):
        self.pdt_t_input = pdt_t_input
        
        self.list_of_corefs = [] # elements will be instances of Coreference_record
    ...
    def read_file( self): # -> list (of coreference records)
        """
